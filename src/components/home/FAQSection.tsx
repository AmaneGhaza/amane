...
export default function FAQSection({ dict }: { dict: Dictionary }) {
  ...
  return (
    <section ref={ref} className="py-20 md:py-24 bg-gradient-to-br from-white to-[#f5f5f5] dark:from-[#000000] dark:to-[#111111]">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#009736]/10 text-[#009736] mb-4">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionItem
                  value={`item-${index}`}
                  className="border rounded-lg px-6 bg-card hover:shadow-lg transition-shadow duration-300 border-[#009736]/20"
                >
